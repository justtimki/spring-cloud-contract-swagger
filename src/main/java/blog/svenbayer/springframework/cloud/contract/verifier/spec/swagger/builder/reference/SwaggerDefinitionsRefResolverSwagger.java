...
public class SwaggerDefinitionsRefResolverSwagger implements SwaggerReferenceResolver {
	...
	/**
	 * Creats a key-value representation for the given reference and Swagger model
	 * definitions.
	 ...
	 */
	private Map<String, Object> resolveDefinitionsRef(String reference,
		...
		if (definitions == null || definitions.get(referenceName) == null
				|| definitions.get(referenceName).getProperties() == null) {
