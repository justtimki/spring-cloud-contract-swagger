...
public class DslValueBuilderTest {
	...
	public void dslValueForExample() {
		...
		DslProperty<Object> actualDslProperty = dslValueBuilder
				.createDslValueForParameter(swaggerQueryParam);
		DslProperty<Object> expectedDslProperty = new DslProperty<>(Pattern.compile(".+"),
				"anExampleValue");
		assertDslPropertyEquals(expectedDslProperty, actualDslProperty,
				"DslProperty was not equals!");
	}
	...
	public void xIgnoreButRequired() {
		...
		assertEquals(
				"Set the parameter 'ignoredButRequired' to required: false to use x-ignore: true",
	...
	public void stringWithNameAndNoExample() {
		...
		DslProperty<Object> actualDslProperty = dslValueBuilder
				.createDslValueForParameter(swaggerQueryParam);
		DslProperty<Object> expectedDslProperty = new DslProperty<>(
				Pattern.compile("[A-Za-z]*"), "nameOfParam");
		assertDslPropertyEquals(expectedDslProperty, actualDslProperty,
				"DslProperty was not equals!");
	}
	...
	public void numberNoExample() {
		...
		DslProperty<Object> actualDslProperty = dslValueBuilder
				.createDslValueForParameter(swaggerQueryParam);
		DslProperty<Object> expectedDslProperty = new DslProperty<>(
				Pattern.compile("[0-9]+"), DEFAULT_INT);
		assertDslPropertyEquals(expectedDslProperty, actualDslProperty,
				"DslProperty was not equals!");
	}
	...
	public void numberDoubleNoExample() {
		...
		DslProperty<Object> actualDslProperty = dslValueBuilder
				.createDslValueForParameter(swaggerQueryParam);
		DslProperty<Object> expectedDslProperty = new DslProperty<>(
				Pattern.compile("[0-9]+\\.[0-9]+"), DEFAULT_DOUBLE);
		assertDslPropertyEquals(expectedDslProperty, actualDslProperty,
				"DslProperty was not equals!");
	}
	...
	public void booleanNoExample() {
		...
		DslProperty<Object> actualDslProperty = dslValueBuilder
				.createDslValueForParameter(swaggerQueryParam);
		DslProperty<Object> expectedDslProperty = new DslProperty<>(
				Pattern.compile("(false|true)"), DEFAULT_BOOLEAN);
		assertDslPropertyEquals(expectedDslProperty, actualDslProperty,
				"DslProperty was not equals!");
	}
	...
	public void stringButPatternDoesNotMatch() {
		...
		assertEquals(
				"The pattern '[0-9]+' does not match for the value 'paramName' for the given param 'paramName'",
				exception.getMessage());
	}
